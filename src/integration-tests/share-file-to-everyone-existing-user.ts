...
t.test(
  "Share a file to the everyone group, an existing user accesses",
  async (t) => {
    t.beforeEach(async () => {
      sinon.resetBehavior();
      sinon.resetHistory();
    ...
    t.test("Create a new share (for everyone group)", async (t) => {
    ...
    t.test("Sign in as existing regular user", async (t) => {
